...
\begin{frame}{\insertsubsectionhead}{}
  ...
  \begin{columns}
    ...
    \begin{table}[t]
      ...
      CV-STEM (\paperinfo{H.~Tsukamoto, S.-J. Chung, and J.-J.~E. Slotine, ``Contraction theory for nonlinear stability analysis and learning-based control: A tutorial overview,'' \emph{Annual Reviews in Control}, 2021}). \\
      \hline
    ...
    \begin{itemize}
      \item Using contraction theory, (C$_1$) and (C$_2$) stabilized the system under the external disturbance at 0.2 s.
      \item (C$_2$) produced excessive input, which is undesirable.
      \item In contrast, (C$_1$) successfully handled the input saturation.
    \end{itemize}
    ...
    \begin{figure}[t]
      ...
      % \caption{
        % Trajectory tracking results and control inputs
      % }
    \end{figure}
