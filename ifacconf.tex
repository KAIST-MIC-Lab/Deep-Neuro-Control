...
\title{
   Contraction Theory, Deep Learning, PMSM
...
\begin{abstract}                % Abstract of 50--100 words
   Besides the traditional Lyapunov stability theory, contraction theory 
   
\end{abstract}

\begin{keyword}
   Contraction theory, deep learning, permanent magnet synchronous motor (PMSM), ...
\end{keyword}
