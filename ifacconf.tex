...
\title{
   Contraction Theory Based Control Under Input Saturation–LMI Approach\thanksref{footnoteinfo}
} 
...
\begin{assum}
   The control input matrix $\mv{B}$ is sign-definite, so that the inverse of $\mm{B}$ exists.
\end{assum}
