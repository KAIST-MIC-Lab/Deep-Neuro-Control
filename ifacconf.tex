...
\title{
   Vector-Valued Optimization for Contraction-Based Control: An Energy-Based Effective Space Approach
...
\begin{abstract}                % Abstract of 50--100 words
   ...
   To address these issues, we project the contraction metrics onto the trajectory error vector space, leading to a simplified vector-valued optimization framework within a lower-dimensional effective space.
   Furthermore, energy-based constraints are incorporated to prevent the contraction metrics from \cred{collapsing or exploding}, thereby maintaining sufficient control effort.
...
\begin{keyword}
   Contraction theory, numerical optimization, input saturation, energy-based control
\end{keyword}
